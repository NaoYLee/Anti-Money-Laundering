...
) COMMENT '账户主表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_ACCOUNT_MASTER' TBLPROPERTIES ("orc.compress" = "SNAPPY");
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_ALERT (
    ...
    CREATED_DATE DATE COMMENT '创建日期',
    UPDATED_DATE DATE COMMENT '更新日期'
) COMMENT '预警表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_ALERT' TBLPROPERTIES ("orc.compress" = "SNAPPY");
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_CUSTOMER_MASTER (
    ...
    UPDATED_BY STRING COMMENT '更新人',
    UPDATED_DATE DATE COMMENT '更新日期'
) COMMENT '客户主表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_CUSTOMER_MASTER' TBLPROPERTIES ("orc.compress" = "SNAPPY");
...
) COMMENT '监控规则表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_MONITORING_RULE' TBLPROPERTIES ("orc.compress" = "SNAPPY");
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_SCREENING_RESULT (
    ...
    CREATED_DATE DATE COMMENT '创建日期'
) COMMENT '筛查结果表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_SCREENING_RESULT' TBLPROPERTIES ("orc.compress" = "SNAPPY");
...
) COMMENT '可疑交易报告表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_SUSPICIOUS_TXN_REPORT' TBLPROPERTIES ("orc.compress" = "SNAPPY");
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_TRANSACTION_DETAIL (
    ...
    CREATED_DATE DATE COMMENT '创建日期'
) COMMENT '交易明细表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_TRANSACTION_DETAIL' TBLPROPERTIES ("orc.compress" = "SNAPPY");
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_UBO_INFO (
    ...
    UPDATED_BY STRING COMMENT '更新人',
    UPDATED_DATE DATE COMMENT '更新日期'
) COMMENT '受益所有人信息表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_UBO_INFO' TBLPROPERTIES ("orc.compress" = "SNAPPY");
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_WATCHLIST_DETAIL (
    ...
    CREATED_DATE DATE COMMENT '创建日期',
    UPDATED_DATE DATE COMMENT '更新日期'
) COMMENT '名单明细表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_WATCHLIST_DETAIL' TBLPROPERTIES ("orc.compress" = "SNAPPY");
...
) COMMENT '名单主表' PARTITIONED BY (ETL_DATE STRING) STORED AS ORC LOCATION '/data/aml/ods/ODS_AML_WATCHLIST_MASTER' TBLPROPERTIES ("orc.compress" = "SNAPPY");