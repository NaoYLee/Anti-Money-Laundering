-- Active: 1754463287424@@192.168.88.148@10000@bigdata
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_ACCOUNT_MASTER (
    ...
    AVG_DAILY_BALANCE DECIMAL(18, 2) COMMENT '日均余额 (可定期计算)',
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_ALERT (
    ...
    SCORE DECIMAL(5, 2) COMMENT '模型评分 (若由模型触发)',
    TRIGGER_AMOUNT DECIMAL(18, 2) COMMENT '触发交易金额',
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_SUSPICIOUS_TXN_REPORT (
    ...
    TOTAL_AMOUNT DECIMAL(18, 2) COMMENT '涉及总金额',
...
TABLE IF NOT EXISTS AML_ODS.ODS_AML_UBO_INFO (
    ...
    UBO_SHARE_PERCENT DECIMAL(5, 2) COMMENT '持股比例(%)',
